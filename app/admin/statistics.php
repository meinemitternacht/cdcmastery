...
<div class="container">
    ...
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tabs-top10">Top 10</a></li>
        ...
        <div id="tabs-users">
            <div class="row">
                    ...
                    <section>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><?php echo number_format($activeSessions); ?></td>
                            </tr>
                            <tr style="border-bottom: 2px solid #999">
                                <td>Inactive Sessions</td>
                                <td colspan="2"><?php echo number_format($inactiveSessions); ?></td>
                            </tr>
                            <tr style="border-bottom: 2px solid #999">
                ...
                <div class="4u">
                    <section>
                        <header>
                            <h2>Active Users: Last 15 Minutes</h2>
                        </header>
                        <?php
                        ...
                        <?php else: ?>
                            <div class="sysmsg-info">No users active in the last fifteen minutes.</div>
                        <?php endif; ?>
                    </section>
                </div>
            </div>
                    ...
                    <section style="height:30em;overflow-y:scroll;overflow-x:hidden;">
                        ...
                        <table id="logActionCountTable">
                            ...
                            <?php foreach($groupedLogActionCountArray as $groupedLogActionCountKey => $groupedLogActionCountValue): ?>
                                <tr>
                                    <td title="<?php echo $groupedLogActionCountKey; ?>">
                                        <span class="<?php echo $systemLog->getRowStyle($groupedLogActionCountKey); ?>">
                                            <?php echo $groupedLogActionCountKey; ?>
                                        </span>
                                    </td>
