        ...
        <div class="row">
            <div class="12u">
                <section>
                    ...
                    <a href="/supervisor/generate-test"
        ...
        <div class="row">
            <div class="4u">
                <section>
                    ...
                    <form action="/supervisor/generate-test" method="POST">
                        ...
                        <table>
                            ...
                            <?php foreach ($userGenTestList as $genTestUUID => $genTestDetails): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/supervisor/generate-test/view/<?php echo $genTestUUID; ?>">View &raquo;</a>
                                        <a href="/supervisor/generate-test/print/<?php echo $genTestUUID; ?>">Print &raquo;</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
