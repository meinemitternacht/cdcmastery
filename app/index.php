		...
		<div class="row">
			...
			<div id="content" class="8u skel-cell-important">
				<section>
					...
					<p>
						<strong>Register now to join over <?php echo number_format($statisticsModule->getTotalUsers()); ?> others who are taking advantage of this comprehensive tool!</strong>
					</p>
				</section>
			</div>
