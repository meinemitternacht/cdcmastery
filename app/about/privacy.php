    ...
    <div class="row">
        <div class="8u">
            <section>
                ...
                <p>
                    This privacy policy sets out how CDCMastery.com uses and protects any information that you give CDCMastery.com when you use this website.<br>
                    <br>
                    CDCMastery.com is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.<br>
                    <br>
                    CDCMastery.com may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective as of August 1, 2012.<br>
                    <br>
                    ...
                    <br>
                    You can choose to accept or decline cookies. Most web browsers automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. This will prevent you from taking full advantage of the website.<br>
                    <br>
