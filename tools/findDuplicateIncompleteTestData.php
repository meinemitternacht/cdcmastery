...
$res = $db->query("SELECT testUUID FROM testManager ORDER BY timeStarted ASC");
...
if(!empty($outputArray)){
    ...
    echo "\nEZ MySQL query to find the tests! : SELECT * FROM testManager WHERE testUUID IN ('".implode("','",$testIDArray)."') ORDER BY testTimeStarted ASC\n";
